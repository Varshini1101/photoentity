...
export const PhotoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplifyMarketplaceApp.photo.delete.question">
        <Translate contentKey="simplifyMarketplaceApp.photo.delete.question" interpolate={{ id: photoEntity.id }}>
